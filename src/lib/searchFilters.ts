...
/** Match filter tag to listing tags, including legacy slug aliases. */
...
export const TAG_LABELS: Record<ListingTag, string> = {
  ...
  "lgbt-friendly": "Comunidad LGBT+",
  "servicios-incluidos": "Servicios incluidos",
  "cerradura-cuarto": "Acceso con llave a recámara",
  "agua-caliente": "Agua caliente",
  "cerca-transporte": "Transporte público cercano",
};
