...
export const LEGAL_LAST_UPDATED = "12 de septiembre de 2026";
    ...
    <div className="rounded-2xl border border-border bg-surface p-5 text-sm leading-relaxed text-body">
      <dl className="space-y-1.5">
        ...
        <div>
          ...
          <dd className="inline">
            Bestie (bestie.mx), en trámite de registro ante el IMPI (expedientes 3678152 y 3679467 en
            clase 35, 3679461 en clase 36 y 3679472 en clase 42)
          </dd>
        </div>
        <div>
