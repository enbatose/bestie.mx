        ...
        <LegalList
          items={[
            ...
            <>
              ...
              de Bestie o a Messenger y las respuestas automáticas de esos canales (incluido el número
              desde el que escribes, las fotos que mandas para un anuncio, los datos del cuarto que
              respondes en el chat —tipo y tamaño de recámara, preferencia de roomies, depósito y
              etiquetas de lo que incluye— y la ubicación aproximada si la compartes),
              ...
              confirmación desde un enlace de correo o SMS, y tus interacciones en la Plataforma. Si un admin publica un borrador de crecimiento sin dueño
        ...
        <LegalList
          items={[
            ...
            <>
              ...
              Facebook o Google a esa cuenta en lugar de dejar un duplicado. Si el celular mexicano que
              confirmas con SMS ya está verificado en otra cuenta (por ejemplo solo de teléfono), al
              verificar el código ligamos esta sesión a esa cuenta y le pasamos el correo si no tenía.
              No unimos dos cuentas que ya tienen correos distintos o dos celulares distintos.
            </>,
            <>
      ...
      <LegalSection id="finalidades" index={6} title="Finalidades del tratamiento">
        ...
        <LegalList
          items={[
            ...
            "Permitir la publicación y consulta de anuncios y el contacto entre usuarios, incluido el chat automático en el WhatsApp Business de Bestie para buscar anuncios o publicar un cuarto (infográficos que lee la IA y se incluyen en la galería pública, descripción opcional —si no la escribes, la IA redacta una con los datos que diste y la ves antes de publicar—, fotos, renta mensual exacta, tipo y tamaño de recámara, preferencia de roomies, depósito, etiquetas de lo que incluye, ubicación aproximada y confirmación expresa en el mismo chat), y el buscador guiado por zona en Messenger.",
            ...
            "Enviar, si agregas tu teléfono y mantienes activa la preferencia correspondiente, comunicaciones transaccionales por SMS o WhatsApp relacionadas con tu cuenta, soporte, actividad en la Plataforma o seguimiento operativo del Servicio. Eso incluye, mientras la función esté activa, un SMS cuando una persona te escribe por primera vez en el chat de un anuncio (como máximo uno por cada persona interesada distinta; si varias escriben en la misma ventana de aviso, unificamos el SMS). El SMS no incluye el contenido del chat: te indica que revises el correo de Bestie.mx —incluida la carpeta de spam— o que abras Mensajes en la Plataforma. También incluye un SMS (y/o correo) cuando publicas un anuncio sin fotos, con un enlace para subirlas.",
            ...
            "Avisarte, a los 25 días de publicado un anuncio o de la última confirmación, que debes decir si sigue libre o ya se rentó; si no respondes, lo ocultamos 5 días después de ese aviso. El aviso nombra el anuncio e incluye un enlace a esa página. Va por correo cuando hay un correo en la cuenta, uno por anuncio. El SMS se envía si hay teléfono y, cuando también hay correo, solo si mantienes activa la preferencia de avisos por teléfono; si varios anuncios de la misma cuenta vencen el mismo día, el SMS es uno esa mañana. Si solo tenemos el número del anuncio y no hay cuenta (anuncios sin reclamar), enviamos un SMS por anuncio a ese número aunque no exista esa preferencia. Esos avisos no se envían entre las 23:00 y las 6:00 hora local del anuncio (reanudamos a las 6:01).",
      ...
      <LegalSection id="transferencias" index={8} title="Transferencias y encargados">
        ...
        <LegalList
          items={[
            ...
            "Proveedor de modelos de inteligencia artificial (Google LLC, Gemini API) para: (i) extraer, a tu solicitud, campos de un anuncio (por ejemplo zona, renta, tipo de espacio, recámaras, depósito, disponibilidad y etiquetas) a partir del texto o infográfico que proporcionas al publicar un cuarto o una propiedad, incluso cuando lo mandas por el WhatsApp Business de Bestie; (ii) generar un texto sugerido de compartir basado en los datos estructurados de tu anuncio (editable por ti; no sustituye la descripción pública ni se usa como vista previa Open Graph); (iii) redactar la descripción pública de un cuarto que publicas por WhatsApp cuando no escribiste una, usando solo los datos que diste en ese chat y mostrándotela en la vista previa antes de publicar; y (iv) extraer criterios de búsqueda a partir de texto o infográficos de un post público de alguien que busca cuarto, o del texto que escribes en WhatsApp o Messenger para buscar, cuando armamos filtros. Un anuncio extraído no se publica hasta que lo confirmas (en el sitio o con el toque de aceptación en WhatsApp).",
          ]}
        />
        <p>
