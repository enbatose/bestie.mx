        ...
        <LegalList
          items={[
            ...
            <>
              ...
              anuncio sigue disponible y códigos cortos para confirmar o pausar ese anuncio desde un
              enlace de correo o SMS, y tus interacciones en la Plataforma. Si un admin publica un borrador de crecimiento sin dueño
      ...
      <LegalSection id="finalidades" index={6} title="Finalidades del tratamiento">
        ...
        <LegalList
          items={[
            ...
            "Avisarte, a los 25 días de publicado un anuncio o de la última confirmación, que debes confirmar que sigue disponible; si no lo confirmas, lo pausamos 5 días después de ese aviso. El aviso nombra el anuncio e incluye enlaces para confirmarlo o pausarlo. Va por correo cuando hay un correo en la cuenta. El SMS se envía si hay teléfono y, cuando también hay correo, solo si mantienes activa la preferencia de avisos por teléfono; si solo tenemos el número del anuncio y no hay cuenta (anuncios sin reclamar), enviamos el SMS a ese número aunque no exista esa preferencia. Esos avisos no se envían entre las 23:00 y las 6:00 hora local del anuncio (reanudamos a las 6:01).",
