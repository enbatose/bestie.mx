      ...
      <LegalSection id="rol" index={8} title="Rol de Bestie e intermediación">
        ...
        <LegalList
          items={[
            ...
            "Antes de ver mensajes entre usuarios o de revelar el teléfono asociado a un anuncio, puedes recibir un aviso de seguridad en la app. Al aceptarlo, reconoces el riesgo de estafas o fraudes entre usuarios y que Bestie y el Titular no son responsables por el uso del chat, llamadas, SMS, WhatsApp ni por acuerdos o pagos entre ustedes. Registramos esa aceptación (fecha y versión del aviso) como evidencia de tu consentimiento. Si revelas el teléfono, llamas o abres WhatsApp hacia el número de un anuncio, también registramos esa acción y, si quien publica tiene cuenta en Bestie, le mostramos una notificación en la app con tu nombre visible y el título del anuncio.",
          ]}
        />
      </LegalSection>
