      ...
      <LegalSection id="servicio" index={3} title="Descripción del servicio">
        ...
        <LegalList
          items={[
            ...
            "Escribir al número de WhatsApp Business de Bestie para buscar anuncios en Guadalajara (zona, presupuesto y preferencia; te enviamos fotos de resultados) o para publicar un anuncio de un solo cuarto desde el mismo chat: envías fotos, una ubicación aproximada (radio de privacidad) y confirmas con un toque de aceptación de estos Términos y del Aviso de Privacidad antes de que el anuncio quede público. Las respuestas en ese chat son automáticas. El celular mexicano desde el que escribes es tu cuenta en Bestie (si aún no tenías una, la creamos al usar el canal). Conservamos ese número, las fotos, la ubicación aproximada y el contenido del hilo para operar el canal. Publicar varias recámaras de una misma propiedad se hace en el sitio. Messenger, si está disponible, usa un flujo guiado distinto y no publica desde el chat.",
