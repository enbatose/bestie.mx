      ...
      <LegalSection id="servicio" index={3} title="Descripción del servicio">
        ...
        <LegalList
          items={[
            ...
            "Escribir al número de WhatsApp Business de Bestie para buscar anuncios con filtros guiados o para recibir un enlace y terminar un anuncio en el sitio (fotos, mapa y confirmación). Las respuestas en ese chat son automáticas. Ningún anuncio se publica solo por chatear: el borrador permanece privado hasta que lo revisas y confirmas en bestie.mx. Conservamos el número desde el que escribes y el contenido de ese hilo para operar el canal.",
