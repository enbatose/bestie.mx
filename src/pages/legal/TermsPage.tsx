      ...
      <LegalSection id="servicio" index={3} title="Descripción del servicio">
        ...
        <LegalList
          items={[
            ...
            "Buscar y filtrar anuncios por ciudad, ubicación en mapa, precio y características. Algunos anuncios no muestran renta ni depósito: aparecen como Consultar $ y se omiten cuando ajustas un rango de precio distinto al predeterminado. Puedes guardar una búsqueda (filtros y zona) y activar un aviso por correo; solo una búsqueda a la vez envía esos avisos. Bestie también puede enviarte un enlace corto de una búsqueda armada a partir de un post público de alguien que busca cuarto: al abrirlo e iniciar sesión, esa búsqueda se guarda en tu cuenta y queda con avisos activos (el correo se envía solo si registraste un correo). Si otra persona ya usa ese enlace, ves los mismos criterios; si tú los modificas, se crea una copia personal con otra dirección.",
