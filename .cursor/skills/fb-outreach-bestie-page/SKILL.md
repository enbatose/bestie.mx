...
- Si el autor parece persona o negocio de rentas. Classify **roommate publisher** vs **owner publisher** using `docs/gtm/gdl-marketplace-personas.md` (do not treat seeker–seeker “busco con quien rentar” as a publisher).
