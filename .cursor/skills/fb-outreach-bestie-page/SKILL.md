...
description: >-
  Draft Facebook group comments from the official Bestie business Page inviting
  landlords/room publishers to post on bestie.mx. Use when the user shares a
  Facebook post screenshot for outreach from the página oficial, cuenta de
  empresa, Page de Bestie, or brand account (not the founder's personal profile).
---
...
Invitar al publicador a publicar en **bestie.mx**, dejando claro:
